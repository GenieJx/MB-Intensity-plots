...
plotPASD <- function(df, rank, covar=NULL, covarColors=NULL) {
  ...
  # }
  legend("top", legend=levels(liers$covar), col=covarColors, pch=15, inset=c(0,-0.02), xpd=TRUE, horiz=TRUE, bty="n")
...
plotIntensity <- function(df, covar=NULL, covarColors=NULL, plotOrder=NULL) {
  ...
  #}
  verticalOffset = 1/nr
  legend("top", legend=levels(df$covar), col=covarColors, pch=15, inset=c(0,-.1), xpd=TRUE, horiz=TRUE, bty="n")
